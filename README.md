...
temporary archive/network failure does not discard completed work.
...
- deletes PNG diagnostics for automatically rejected targets after the
  campaign-wide common-mode screen finishes; and
...
regenerated by rerunning those targets from their retained JSON settings.
...
subtraction. The campaign vetoes signals whose event timing is shared across
many unrelated stars, a common signature of spacecraft settling or downlinks.
